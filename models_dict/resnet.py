...
class WResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, k, num_classes=10):
        ...
        self.layer3 = self._make_layer(block, 256*k, num_blocks[2], stride=2)
        self.layer4 = self._make_layer(block, 512*k, num_blocks[3], stride=2)
        self.linear = nn.Linear(512*k*block.expansion, num_classes)
...
#     return ResNet_fedlaw(BasicBlock_resnet18, [2,2,2,2],num_classes)


# def ResNet18(num_classes):
#     return ResNet(BasicBlock_resnet18, [2,2,2,2],num_classes)
...
def WRN56_4_imagenet(num_classes):
    depth = 56
    n = (depth - 2) // 6
    return WResNet(BasicBlock, [n,n,n], 4, num_classes)
